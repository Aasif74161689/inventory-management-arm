...
const batteryBOM = [
  ...
  { productId: "PD-004", name: "Positive Filling (Oxide)", qty: 0.258 },
  { productId: "PD-005", name: "Negative Pasting (Oxide)", qty: 0.312 },
  { productId: "PD-006", name: "Positive Filling (Red Oxide)", qty: 0.086 },
